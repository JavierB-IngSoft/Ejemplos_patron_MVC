...
public class CalculadoraVista extends JFrame implements CalculadoraInterfaz {
    ...
    public CalculadoraVista() {
        setTitle("Calculadora de Suma original");
    ...
    public void addRestaListener(ActionListener listener) {
